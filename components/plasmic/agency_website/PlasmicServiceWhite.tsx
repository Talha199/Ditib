...
import sty from "./PlasmicServiceWhite.module.css"; // plasmic-import: mApax7JlNwjt/css
...
function PlasmicServiceWhite__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      <div className={classNames(projectcss.all, sty.freeBox___8ENhM)}>
        {renderPlasmicSlot({
          defaultContents: (
            <BlueBdr
              className={classNames("__wab_instance", sty.blueBdr__o6A7)}
            />
          ),
      ...
      <div className={classNames(projectcss.all, sty.freeBox__zh9Y6)}>
        {renderPlasmicSlot({
          defaultContents:
...
type NodeComponentProps<T extends NodeNameType> =
  // Explicitly specify variants, args, and overrides as objects
  {
    ...
    Omit<PlasmicServiceWhite__VariantsArgs, ReservedPropsType> &
