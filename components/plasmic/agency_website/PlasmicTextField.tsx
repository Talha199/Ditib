...
import Label from "../../Label"; // plasmic-import: 5fLxu9mYdxXw/component
import TextInput from "../../TextInput"; // plasmic-import: NIPOZxQ6aYha/component
import TextAreaInput from "../../TextAreaInput"; // plasmic-import: 7NGpwiXLBs50/component
import Description from "../../Description"; // plasmic-import: AJ_uA7h9FfBx/component
...
import sty from "./PlasmicTextField.module.css"; // plasmic-import: lpLVDnPpY_dI/css
...
function PlasmicTextField__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      <div
        className={classNames(projectcss.all, sty.freeBox__nLahD, {
          [sty.freeBoxiconEnd__nLahDuLk5C]: hasVariant(
            $state,
            "iconEnd",
            "iconEnd"
          ),
          [sty.freeBoxiconStart__nLahDrXhWa]: hasVariant(
            $state,
            "iconStart",
            "iconStart"
          ),
          [sty.freeBoxmultiLine__nLahDwHez9]: hasVariant(
            $state,
            "multiLine",
            "multiLine"
          )
      ...
      >
        <div
          className={classNames(projectcss.all, sty.freeBox__mvj8A, {
            [sty.freeBoxiconStart__mvj8ARXhWa]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            ),
            [sty.freeBoxmultiLine__mvj8AWHez9]: hasVariant(
              $state,
              "multiLine",
              "multiLine"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg__fQZgz)}
                role={"img"}
              />
            ),
        ...
        <div
          className={classNames(projectcss.all, sty.freeBox__jvWj, {
            [sty.freeBoxiconEnd__jvWjULk5C]: hasVariant(
              $state,
              "iconEnd",
              "iconEnd"
            ),
            [sty.freeBoxiconStart__jvWjRXhWa]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg__yyV8K)}
                role={"img"}
              />
            ),
